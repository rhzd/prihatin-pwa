<template>
  <div class="" style="">
    <q-list padding>
      ...
      <q-item>
        <q-item-section side>
          <q-icon color="teal" name="eva-volume-down-outline" />
        </q-item-section>
        <q-item-section>
          <q-slider v-model="volume" :min="0" :max="10" label color="teal" />
        </q-item-section>
        <q-item-section side>
          <q-icon color="teal" name="eva-volume-up-outline" />
        </q-item-section>
      </q-item>

      <q-item>
        <q-item-section side>
          <q-icon color="deep-orange" name="eva-sun-outline" />
        </q-item-section>
        <q-item-section>
          <q-slider
            v-model="brightness"
      ...
      <q-item>
        <q-item-section side>
          <q-icon color="primary" name="eva-mic-outline" />
        </q-item-section>
        <q-item-section>
